"""
Value NASDAQ Agent - Fundamental Value Investing for NASDAQ 100

Self-contained agent implementing value strategy for NASDAQ 100 trading.
Uses shared ClaudeCodeAgent base with value-specific methodology.
"""
...
from agent.value_agent.strategy import ValueStrategy
from agent.claude_code_agent.shared.instructions import build_claude_md
from prompts.agent_prompt import all_nasdaq_100_symbols


class ValueNASDAQAgent(ClaudeCodeAgent):
    """Value agent with balanced risk management."""
    ...
    def _setup_claude_instructions(self) -> None:
        """Generate CLAUDE.md from shared base + value-specific sections."""
    ...
    def _get_mcp_config(self) -> dict:
        """MCP server configuration for value strategy."""
        return {
            "mcpServers": {
                "sequential-thinking": {
                    "command": "npx",
    ...
    def __str__(self) -> str:
        return f"ValueNASDAQAgent(signature='{self.signature}')"
