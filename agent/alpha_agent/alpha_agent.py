"""
Alpha NASDAQ Agent - Statistical Arbitrage for NASDAQ 100

Self-contained agent implementing alpha strategy for NASDAQ 100 trading.
Uses shared ClaudeCodeAgent base with alpha-specific methodology.
"""
...
from agent.alpha_agent.strategy import AlphaStrategy
from agent.claude_code_agent.shared.instructions import build_claude_md
from prompts.agent_prompt import all_nasdaq_100_symbols


class AlphaNASDAQAgent(ClaudeCodeAgent):
    """Alpha agent with balanced risk management."""
    ...
    def _setup_claude_instructions(self) -> None:
        """Generate CLAUDE.md from shared base + alpha-specific sections."""
    ...
    def _get_mcp_config(self) -> dict:
        """MCP server configuration for alpha strategy."""
        return {
            "mcpServers": {
                "sequential-thinking": {
                    "command": "npx",
    ...
    def __str__(self) -> str:
        return f"AlphaNASDAQAgent(signature='{self.signature}')"
